...
fgb() {
  ...
  branches=$(git for-each-ref --count=31 --sort=-committerdate refs/heads/ --format="%(refname:short)") &&
...
# Created by `pipx` on 2025-04-07 02:42:43
export PATH="$PATH:/Users/jacobjohnston/.local/bin"
